...
SUMMARY = PACKAGE_ROOT / "results/all_poisson/summaries/all_poisson_summary.csv"
VALIDATION = PACKAGE_ROOT / "results/all_poisson/metadata/validation_report.json"
CONFIG = PACKAGE_ROOT / "config/all_poisson_final.json"
OUT = PACKAGE_ROOT / "final_figures"
